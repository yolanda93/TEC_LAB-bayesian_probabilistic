...
Dentro de este contexto podríamos resaltar **aplicaciones de sistemas embebidos** por la capacidad que podrían ofrecer para reducir la complejidad de la red (*neural network prunning*) ssin empeorar su robustez en aplicaciones en tiempo real con recursos límitados
